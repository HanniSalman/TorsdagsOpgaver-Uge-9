...
class Main{
	public static void main(String[] args) {
		...
		GameMenu play = new GameMenu(actions);
		...
		//play.displayMenu(actions);

		//play.getAction(actions);

		String userChoice = play.getAction(actions);
		int choices = Integer.parseInt(userChoice);
		doAction(choices);
	}
